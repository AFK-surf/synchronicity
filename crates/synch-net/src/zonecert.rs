...
///
/// These are the OID's DER *content* bytes: `0x41` is `2.25` packed into the
/// first byte (40 × 2 + 25), and the rest is the UUID's integer value in
/// base-128 continuation form.
pub const OID_DNSSEC_CHAIN: &[u8] = &[
    0x41, 0x83, 0xb9, 0xba, 0xac, 0xc1, 0xf5, 0x9a, 0xca, 0xb7, 0xc3, 0x89, 0xff, 0x9e, 0xe4, 0xa7,
    0xca, 0xb6, 0xbf, 0x3e,
];
...
pub const OID_SUCCESSION: &[u8] = &[
    0x41, 0x81, 0x87, 0xda, 0x94, 0xcc, 0xcc, 0xfa, 0xe2, 0xb8, 0x87, 0xbc, 0xdf, 0xb2, 0x99, 0x9f,
    0xf7, 0x99, 0xf4, 0x02,
];
